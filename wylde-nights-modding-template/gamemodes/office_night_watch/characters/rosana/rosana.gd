...
const ADVERTS: Array[CompressedTexture2D] = [
	preload("res://gamemodes/office_night_watch/characters/rosana/sprites/icon.svg")
]

const ROSANA_ADVERT = preload("res://gamemodes/office_night_watch/characters/rosana/rosana_advert.tscn")
